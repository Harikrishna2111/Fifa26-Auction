...
def flush_batch(cur, batch):
    ...
    sql = """
        ...
        ON CONFLICT (player_id) DO UPDATE SET
            ...
            power_shot_power = COALESCE(EXCLUDED.power_shot_power, players.power_shot_power),
            power_long_shots = COALESCE(EXCLUDED.power_long_shots, players.power_long_shots),
            attacking_short_passing = COALESCE(EXCLUDED.attacking_short_passing, players.attacking_short_passing),
            ...
            power_jumping = COALESCE(EXCLUDED.power_jumping, players.power_jumping),
            power_stamina = COALESCE(EXCLUDED.power_stamina, players.power_stamina),
            power_strength = COALESCE(EXCLUDED.power_strength, players.power_strength),
            mentality_aggression = COALESCE(EXCLUDED.mentality_aggression, players.mentality_aggression),
