...
def flush_batch(cur, batch):
    ...
    sql = """
        ...
        ON CONFLICT (id) DO UPDATE SET
            ...
            pac = COALESCE(EXCLUDED.pac, players.pac),
            sho = COALESCE(EXCLUDED.sho, players.sho),
            dri = COALESCE(EXCLUDED.dri, players.dri),
            ...
            value = COALESCE(EXCLUDED.value, players.value),
            wage = COALESCE(EXCLUDED.wage, players.wage),
            ...
            pas = COALESCE(EXCLUDED.pas, players.pas),
            def = COALESCE(EXCLUDED.def, players.def),
            phy = COALESCE(EXCLUDED.phy, players.phy),
